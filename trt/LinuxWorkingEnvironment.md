...
1. 手动下载文件并修改cmake
* 有个文件很难下下来，先下载下载在放在指定位置:[protobuf下载](https://github.com/google/protobuf/releases/download/v3.0.0/protobuf-cpp-3.0.0.tar.gz)
...
1. CmakeLists集成
    ...
    # 设置为TensorRT的根目录
    set(TRT_DIR "TensorRT/TensorRT-8.2.4.2")
    set(TRT_SAMPLE "TensorRT/demo")
    # 其他配置
